...
from base.models import Description, IndexDescription, Carousel
...
admin.site.site_header = 'North West Kenya Conference'
admin.site.site_title = 'North West Kenya Conference Dashboard'
