var OneTrustStub = function(t) {
    ...
    var l = new function() {
        ...
        e = (i.prototype.initConsentSDK = function() {
            ...
            this.setDomainDataFileURL(), this.otFetch(l.bannerDataParentURL, this.getLocation.bind(this))
            ...
            if (e.OneTrust && e.OneTrust.geolocationResponse) {
                ...
                var a = this.readCookieParam(l.optanonCookieName, l.geolocationCookiesParam);
            ...
            var e = t.TenantFeatures,
                i = "" + l.stubScriptElement.getAttribute("src").split(l.stubFileName)[0] + t.Version;
            if (new RegExp("^file://", "i").test(i) && t.MobileSDK) {
                var a = "/" + t.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js";
                return e && e.CookieV2GeolocationJsonApi ? l.storageBaseURL + a : "." + a
            }
            return t.GeolocationUrl
        }, i.prototype.geoLocationJsonCallback = function(t, e) {
            e && this.setGeoLocation(e.country, e.state), this.addBannerSDKScript(t)
        }, i.prototype.getGeoLocation = function(t) {
            var e = this,
                i = t.TenantFeatures,
                a = this.getGeolocationURL(t);
            i && i.CookieV2GeolocationJsonApi ? this.otFetch(a, this.geoLocationJsonCallback.bind(this, t), !0) : (window.jsonFeed = function(t) {
                e.setGeoLocation(t.country, t.state)
            }, this.jsonp(a, this.addBannerSDKScript.bind(this, t)))
        }, i.prototype.setGeoLocation = function(t, e) {
            void 0 === e && (e = ""), l.userLocation = {
                country: t,
                state: e
            }
        }, i.prototype.otFetch = function(t, e, i) {
            if (void 0 === i && (i = !1), new RegExp("^file://", "i").test(t)) this.otFetchOfflineFile(t, e);
            else {
                ...
                a.onload = function() {
                    ...
                    e()
                }, a.open("GET", t), i && a.setRequestHeader("accept", "application/json"), a.send()
            }
            ...
            i.setAttribute("src", t), i.async = !0, i.type = "text/javascript", this.crossOrigin && i.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(i), new RegExp("^file://", "i").test(t) || l.mobileOnlineURL.push(t), e && (i.onload = i.onerror = function() {
                e()
            })
        }, i.prototype.getRegionSet = function(t) {
            var e, i, a, o = l.userLocation,
            ...
            for (var s = o.state.toLowerCase(), r = o.country.toLowerCase(), p = 0; p < t.RuleSet.length; p++)
                if (!0 === t.RuleSet[p].Global) a = t.RuleSet[p];
                    ...
                    var c = t.RuleSet[p].States;
                    if (c[r] && 0 <= c[r].indexOf(s)) {
                        i = t.RuleSet[p];
                        break
                    }
        ...
        }, i.prototype.initializeGenVenData = function() {
            ...
            for (t = 0; t < l.optanonHostData.length; t++) this.endsWith(l.optanonHostData[t], ":1") && e.push(l.optanonHostData[t].replace(":1", ""));
            for (t = 0; t < l.genVendorsData.length; t++) this.endsWith(l.genVendorsData[t], ":1") && e.push(l.genVendorsData[t].replace(":1", ""));
            ...
            var a, o = new CustomEvent("consent.onetrust", {
                detail: e
            });
            e.length && (window.dataLayer.constructor === Array && window.dataLayer.push({
                event: "OneTrustGroupsUpdated",
                OnetrustActiveGroups: i
            }), a = new CustomEvent("OneTrustGroupsUpdated", {
                detail: e
            })), setTimeout(function() {
                window.dispatchEvent(o), a && window.dispatchEvent(a)
            })
            ...
            t && (l.isMigratedURL ? l.storageBaseURL = t.split("/consent/" + l.migratedCCTID)[0] : l.storageBaseURL = e ? t.split("/consent")[0] : t.split("/scripttemplates/" + l.stubFileName)[0]), l.bannerBaseDataURL = l.storageBaseURL && l.storageBaseURL + "/consent/" + l.domainDataFileName, l.bannerDataParentURL = l.bannerBaseDataURL + "/" + l.domainDataFileName + ".json"
        ...
        }, i.prototype.removeTcf = function() {
    ...
    function i() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = null, this.addBannerSDKScript = function(t) {
            var e = null;
            c.iabTypeAdded && ("IAB" !== (e = c.getRegionSet(t)).Type && "IAB2" !== e.Type || (c.iabType = e.Type, c.intializeIabStub()), "IAB2" !== e.Type && c.removeTcf());
            var i = l.stubScriptElement.cloneNode(!0),
                a = "";
            a = t.UseSDKRefactor ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version + "/" + l.bannerScriptName) : "5.11.0" === t.Version ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/old/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + l.bannerScriptName) : (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/" + t.Version + "/" + l.bannerScriptName);
            ...
            }), c.crossOrigin = l.stubScriptElement.getAttribute("crossorigin") || null, c.isAmp = !!l.stubScriptElement.getAttribute("amp"), c.domainId = l.stubScriptElement.getAttribute("data-domain-script"), window.otStubData = {
                domainData: t,
                stubElement: i,
            ...
            var t = window;
            c.iabTypeAdded ? ("IAB" === c.iabType ? void 0 === t.__cmp && (window.__cmp = c.executeCmpApi) : void 0 === t.__tcfapi && (window.__tcfapi = c.executeTcfApi), c.addIabFrame()) : c.addBackwardIabFrame(), t.receiveOTMessage = c.receiveIabMessage, (t.attachEvent || window.addEventListener)("message", t.receiveOTMessage, !1)
        }, this.addIabFrame = function() {
            var t = window,
                e = "IAB" === c.iabType ? "__cmpLocator" : "__tcfapiLocator";
            !t.frames[e] && (t.document.body ? c.addLocator(e, "CMP") : setTimeout(c.addIabFrame, 5))
        }, this.addBackwardIabFrame = function() {
            var t = window,
                e = "__cmpLocator";
            !t.frames[e] && (t.document.body ? c.addLocator(e, "CMP") : setTimeout(c.addIabFrame, 5));
            var i = "__tcfapiLocator";
            !t.frames[i] && (t.document.body ? c.addLocator(i, "TCF") : setTimeout(c.addIabFrame, 5))
            ...
            } else t.__cmpCall && "IAB2" === c.iabType && console.log("Expecting IAB TCF v2.0 vendor iFrame call; Received IAB TCF v1.1");
            if (t.__tcfapiCall && "IAB2" === c.iabType) {
                var r = t.__tcfapiCall.callId,
                    p = t.__tcfapiCall.command,
                    i = (e = t.__tcfapiCall.parameter, t.__tcfapiCall.version);
                c.executeTcfApi(p, e, function(t, e) {
                    var i = {
                        __tcfapiReturn: {
                            returnValue: t,
                            success: e,
            ...
            } else t.__tcfapiCall && "IAB" === c.iabType && console.log("Expecting IAB TCF v1.1 vendor iFrame call; Received IAB TCF v2.0")
            ...
            if ("function" == typeof o && i)
                if (l.isStubReady && l.IABCookieValue) switch (i) {
                    case "ping":
                        c.getPingRequest(o, !0);
                        break;
                    case "getConsentData":
                        c.getConsentDataRequest(o);
                        break;
                    default:
                        c.addToQueue(i, a, o)
                } else c.addToQueue(i, a, o)
        }, this.executeTcfApi = function() {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            if (c.iabType = "IAB2", !t.length) return window.__tcfapi.a || [];
            var i = t[0],
                a = t[1],
                o = t[2],
                n = t[3];
            "function" == typeof o && i && ("ping" === i ? c.getPingRequest(o) : c.addToQueue(i, a, o, n))
        }, this.addToQueue = function(t, e, i, a) {
            var o = window,
                n = "IAB" === c.iabType ? "__cmp" : "__tcfapi";
            o[n].a = o[n].a || [], o[n].a.push([t, e, i, a])
